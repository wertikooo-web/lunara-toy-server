...
const BUILTIN_SHORT_ITEMS = [
    {
        ...
        text: 'Днём он дремлет на окошке. Ночью тихо ходит по дому. Если доволен, мурлычет. Кто это?',
    ...
    },
    {
        ...
        text: 'Когда становится темно, я появляюсь высоко-высоко. Не грею, как печка, но светить умею. Кто я?',
        answers: ['луна', 'месяц'],
    ...
    },
    {
        ...
        text: 'Я встаю раньше всех. Бужу окна, грею щёки и к вечеру ухожу за горизонт. Кто я?',
    ...
    },
    {
        ...
        text: 'В сухую погоду я сплю. А под дождём раскрываюсь над головой, как маленькая крыша. Что это?',
        answers: ['зонт', 'зонтик'],
    ...
    },
    {
        ...
        text: 'Во мне живут принцессы, драконы, космос и смешные звери. Откроешь меня — начнётся история. Что это?',
    ...
    },
    {
        ...
        text: 'Я лёгкая, белая и плыву по небу. Иногда похожа на корабль, иногда на барашка. Кто я?',
    ...
    },
    {
        ...
        text: 'Без кисточки рисует узоры на окне. Щиплет нос и любит снежинки. Кто это?',
        answers: ['мороз'],
    ...
    },
    {
        ...
        text: 'Я не бегаю, но у меня есть стрелки. Я молчу, но показываю, когда пора гулять или спать. Что это?',
        answers: ['часы', 'часики'],
    ...
    },
    {
        ...
        text: 'У меня много зубчиков, но я никого не кусаю. Я делаю волосы аккуратными. Что это?',
    ...
    },
    {
        ...
        text: 'Их всегда двое. Они ждут у двери и помогают ногам идти гулять. Что это?',
    ...
    },
    {
        ...
        type: 'tongue_twister',
        title: 'Саша и шишки',
        text: 'Шла Саша по шоссе и сосала сушку. Давай медленно. Потом быстрее.',
    ...
    },
    {
        ...
        type: 'mini_game',
        title: 'Назови три',
        text: 'Назови три круглых предмета. Я подожду, а потом мы проверим вместе.',
    ...
    },
    {
        ...
        text: 'Я скажу звук, а ты угадай животное. Мяу-мяу. Кто это?',
        tags: ['short', 'animal', 'age_3_8'],
    },
    {
...
const MULTILINGUAL_SHORT_ITEMS = [
    {
        ...
        text: 'Sunt cald si luminos. Dimineata trezesc lumea, iar seara ma ascund dupa deal. Cine sunt?',
    ...
    },
    {
        ...
        text: 'Apar pe cer cand se face intuneric. Nu incalzesc, dar stralucesc bland. Cine sunt?',
    ...
    },
    {
        ...
        text: 'Suntem mereu doi si stam langa usa. Ajutam picioarele sa mearga la plimbare. Ce suntem?',
    ...
    },
    {
        ...
        type: 'mini_game',
        title: 'Numeste trei',
        text: 'Numeste trei lucruri rotunde. Eu astept, apoi le verificam impreuna.',
        tags: ['short', 'thinking', 'age_3_8'],
        lang: 'ro-RO',
    },
    {
        ...
        text: 'Eu spun un sunet, iar tu ghicesti animalul. Miau-miau. Cine este?',
        tags: ['short', 'animal', 'age_3_8'],
        lang: 'ro-RO',
    },
    {
        ...
        type: 'riddle',
        title: 'Morning light',
        text: 'I am warm and bright. In the morning I wake the world, and in the evening I hide away. What am I?',
        answers: ['sun', 'the sun'],
        tags: ['short', 'nature', 'age_3_8'],
        lang: 'en-US',
    },
    {
        ...
        type: 'riddle',
        title: 'Night lights',
        text: 'I come out when the sky gets dark. I do not warm you, but I sparkle softly. What am I?',
    ...
    },
    {
        ...
        type: 'riddle',
        title: 'Walking pair',
        text: 'We are always two. We wait by the door and help your feet go outside. What are we?',
        answers: ['shoes', 'boots'],
        tags: ['short', 'object', 'age_3_8'],
        lang: 'en-US',
    },
    {
        ...
        type: 'tongue_twister',
        title: 'Tiny turtle',
        text: 'Tiny turtle tiptoes to the tall tree. Say it slowly, then a little faster.',
        tags: ['short', 'speech', 'age_4_8'],
        lang: 'en-US',
    },
    {
        ...
        type: 'tongue_twister',
        title: 'Blue balloon',
        text: 'Blue balloon bounces by the big bed. Try it with a smile.',
        tags: ['short', 'speech', 'age_4_8'],
        lang: 'en-US',
    },
    {
        ...
        type: 'mini_game',
        title: 'Name three',
        text: 'Name three round things. I will wait, then we will check them together.',
        tags: ['short', 'thinking', 'age_3_8'],
        lang: 'en-US',
    },
    {
        ...
        type: 'mini_game',
        title: 'Animal sound',
        text: 'I will make a sound, and you guess the animal. Meow-meow. Who is it?',
        tags: ['short', 'animal', 'age_3_8'],
        lang: 'en-US',
    },
];
