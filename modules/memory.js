...
function formatProfileForPrompt(profile, toyName = 'Lumi') {
    ...
    return [
        ...
        'Если значения выше записаны не на языке текущего разговора, молча переведи их смысл на язык разговора при использовании — никогда не произноси их на другом языке и не показывай ребёнку как есть.',
    ].join('\n');
}
